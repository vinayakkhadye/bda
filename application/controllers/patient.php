...
class Patient extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->load->model(array('common_model','user_model','patient_model','location_model','sendsms_model','media_model'));
	...
	function details()
	{
		...
		if( ! empty($submit))
		{
			...
			else
			{
				...
				echo $this->user_model;
				$patient_id = $this->patient_model->update_patient_by_userid($userid, $_POST, $filename_path);
				echo $this->patient_model;
				redirect('/patient/details');
			}
		}
		$this->load->view('login/patient_details', isset($data) ? $data : NULL);
	}
	...
	function appointments()
	{
		...
		$this->load->view('login/patient_appointments', isset($data) ? $data : NULL);
	}
	...
	function changepassword()
	{
		...
		$this->load->view('login/patient_changepassword', isset($data) ? $data : NULL);
	}
	...
	function profile()
	{
		...
		$this->load->view('login/patient_profile', isset($data) ? $data : NULL);
	}
	...
	function dashboard()
	{
		...
		$this->load->view('login/patient_dashboard', isset($data) ? $data : NULL);
	}
	...
	function phi()
	{
		...
		$this->load->view('login/patient_phi', isset($data) ? $data : NULL);
	...
	function phr()
	{
		...
		$this->load->view('login/patient_phr', isset($data) ? $data : NULL);
	}
