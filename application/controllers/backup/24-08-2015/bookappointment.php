...
class Bookappointment extends CI_Controller
{
	...
	public function saveappointment()
	{
		...
		if($insert_id)
		{
			...
			$notification_msg	=	urlencode($this->post["doctor_name"]." - ".$this->post['doctor_contact_number'].", ".$this->post['clinic_contact_number']." Patient - ".$this->post['patient_name']." - ".$this->post['mobile_number']." @".date("dS M Y \a\t h:i a",strtotime($this->post['date']." ".$this->post['time'])));
