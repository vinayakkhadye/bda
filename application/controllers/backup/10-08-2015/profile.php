...
class Profile extends CI_Controller
{
	...
	public function doctor($id = '')
	{
		...
		$search_array	=	array('id'=>$id,'url_name'=>$url_name,'detail'=>TRUE,'column'=>array('doc.user_id','doc.id as doctor_id','doc.gender as doctor_gender','doc.name as doctor_name','doc.summary','doc.image as doctor_image','doc.speciality','doc.other_speciality','doc.qualification as qualification','doc.yoe','doc.is_ver_reg','doc.health_utsav'),'limit' =>1);
