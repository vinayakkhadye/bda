...
class Bookappointment extends CI_Controller
{
	...
	public function saveappointment()
	{
		...
		if($insert_id)
		{
			$notification_msg	=	urlencode("you have a new appointment for doctor ".$this->post["doctor_name"]." @".date("dS M Y \a\t h:i a",strtotime($this->post['date']." ".$this->post['time']))." for ".$this->post['patient_name']." - ".$this->post['mobile_number']);
