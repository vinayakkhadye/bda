...
class Home extends CI_Controller
{
	...
	{
			parent::__construct();
			$this->load->model(array('common_model','user_model','location_model','page_model','clinic_model','doctor_model','reviews_model'));
	}
	...
	public function index($params)
	{
		...
		else
		{
			...
			$this->data['metadata']['title']         = 'Find trusted Doctors in ' . ucfirst($params[0]) . ' and book appointment | Book Doctor Appointment';
			$this->data['metadata']['canonical_url'] = BASE_URL;
			$this->data['metadata']['keywords']      = 'Book doctor appointment, book doctor appointment for free, book dr appointment, book dr appointment for free, doctor appointment online, doctor appointment online  for free, doctor appointment online free, free doctor appointment online, find doctors, find doctors in ' . ucfirst($params[0]) . ', find doctors ' . ucfirst($params[0]) . ' free, find doctors in ' . ucfirst($params[0]) . ' for free';
			$this->data['metadata']['h1_text']       = 'Best Doctors in ' . ucfirst($params[0]);
		}
