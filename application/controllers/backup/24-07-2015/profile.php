...
class Profile extends CI_Controller
{
	...
	public function doctor($id = '')
	{
		...
		$search_array	=	array('id'=>$id,'detail'=>TRUE,'column'=>array('doc.user_id','doc.id as doctor_id','doc.gender as doctor_gender','doc.name as doctor_name','doc.summary','doc.image as doctor_image','doc.speciality','doc.other_speciality','doc.qualification as qualification','doc.yoe','doc.is_ver_reg'),'limit' =>1);
		...
		if(is_array($this->data['doctor']) && sizeof($this->data['doctor']) > 0)
		{
			...
			if(!empty($this->data['doctor']['speciality']))
			{
				...
				$this->data['doctor']['specialityStr'] = trim($this->data['doctor']['specialityStr'],", ");
			}
