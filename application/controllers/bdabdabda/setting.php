...
class setting extends CI_Controller{
	...
	function download_csv()
	{
		...
		echo $this->adminsetting_model;exit;
		foreach ($this->data['data']  as $fields)
		{
			...
			$out_data['contact_number']	=	($fields['clinic_contact_number'])?$fields['clinic_contact_number']:$fields['doc_contact_number'];
	...
	// for auto complet function
	function get_dr_list()
	{
		$this->data1 = $this->get['query'];
		$this->data['doctor'] = $this->adminsetting_model->doctor_list_pass($this->data1); 
		$data	=	 array();
		foreach($this->data['doctor'] as $key=>$val)
		{
