...
class Search extends REST_Controller
{
	...
	public function doctorlist_by_speciality_location_post()
	{
		...
		$offset	=	($page_id-1)*LIMIT;				$file_log = DOCUMENT_ROOT."logs/search_log.log";		$this->log_file = fopen($file_log, "a+"); 		$this->log_message($this->log_file,$this->post('city_id')."--".$this->post('speciality_id')."--".$this->post('location_id').NEW_LINE);		$this->log_message($this->log_file,"-----------end of line-----------------".NEW_LINE);
