...
class crons extends CI_Controller
{
	...
	function send_feedback_mail()
	{
		...
		$sql = "SELECT id, patient_name, patient_email FROM appointment WHERE STATUS = 1 AND confirmation = 1 AND scheduled_time BETWEEN '".$start."' AND '".$end."'";
		$sql = "SELECT doctor_id, patient_name, patient_email FROM appointment WHERE STATUS = 1 AND confirmation = 1 AND scheduled_time 
		BETWEEN '2015-07-02 00:00:00' AND '2015-08-03 00:00:00' limit 1";
