...
define("BASE_URL",'http://www.bookdrappointment.com/'); /* constants.php loads before config.php that's why BASE_URL declared here and constant used in config.php*/
define("MAIN_URL",'http://www.bookdrappointment.com/'); 
