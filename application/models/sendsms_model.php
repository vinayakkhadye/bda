...
{	
	...
	public function send_sms($mobile,$message)
	{
		...
		return $this->insert_sms_log($mobile,$message);
	...
	public function insert_sms_log($mobile_number,$message)
	{
		$status	=	0;
		$rs  = $this->db->query("INSERT INTO `raw_sms_log`(`mobile_number`,`message`,`status`)VALUES ('".$mobile_number."','".$message."','".$status."')");
	...
	{
		$message = urlencode("Patient ".$a['name']." (".$a['mobile_number'].") has just booked an Appointment with you via BookDrAppointment.com at ".$a['clinic_name']." on ".$a['time'].". Reason: ".$a['reason_for_visit'].". Downaload our Doctor App https://play.google.com/store/apps/details?id=com.bookdrappointment.doctorapp");
