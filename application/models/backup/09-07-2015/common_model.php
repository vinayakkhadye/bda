...
class common_model extends CI_Model {
	...
	{
		$meta_data['title'] =  "Book Doctor Appointment Online for Free | Find Doctors in Mumbai - Book Dr Appointment";
		$meta_data['description'] =  "BDA allows Patients to search the nearby trusted specialists and book their doctor appointments Online instantly. It helps Doctors manage their Practice in a Smart and effective manner.";
		$meta_data['keywords'] =  "book doctor appointment, book doctor appointment for free, book dr appointment, book dr appointment for free, doctor appointment online, doctor appointment online  for free, doctor appointment online free, free doctor appointment online, find doctors, find doctors in Mumbai, find doctors Mumbai free, find doctors in Mumbai for free";
		return $meta_data;
	}
	...
	function setCurrentCity($a=array())
	{
		...
		if(isset($a['cityName']) && !empty($a['cityName'])){
			...
			$cityName = "mumbai"; # get city from geoip
			$cookie = array(
				'name'   => 'cityName',
				'value'  => $cityName,
				'expire' => '0',
