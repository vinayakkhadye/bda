...
class user_model extends CI_Model
{
	...
	{
		parent::__construct();
		$this->load->model(array('mail_model','sendsms_model','hospital_model'));
	}
	...
	function create_account($data, $filename)
	{
		...
		{
			$hospital_details	=	 array('user_id'=>$insertid,'name'=>$data["name"],'image'=>$filename);
			$this->hospital_model->add_hospital($hospital_details);
		}
		return $insertid;
	}
