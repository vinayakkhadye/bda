...
<form class="form-inline" method="GET" action="">
  ...
  <div class="form-group">
    ...
    <select name="status" class="form-control" >
      ...
      <option value="2" <?=(isset($_GET['status']) && $_GET['status']==2)?'selected':''?>>Other</option>
...
<form name="edit_records" id="edit_records" method="post" class="" >
    ...
    <div class="btn-group PB5">
	    <button type="submit" name="submit" value="Other" class="btn btn-primary">Mark As Other</button>
    ...
    <table class="table table-striped table-condensed table-bordered">
                  ...
                  <?php }}?>
								...
								<td>
									<?php if($row->status == '1'): ?>Enabled<?php elseif($row->status == '2'): ?>Other<?php elseif($row->status == '0'): ?>Disabled<?php else: ?>Deleted<?php endif; ?>
                </td>
								<td>
