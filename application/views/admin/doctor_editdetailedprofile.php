...
<body>
  ...
  <div id="experience_more_to_copy">
    ...
    <option value="<?=str_replace("'","",$val['name'])?>"><?=str_replace("'","",$val['name'])?></option>
    <?php } ?>
    </select>
    </div>
    <div class="col-sm-1">
  ...
  <?php foreach($from_year as $val){?>
  <option value="<?=str_replace("'","",$val)?>"><?=str_replace("'","",$val)?></option>
  <?php } ?>
  </select>
  </div>
  <div class="col-sm-2">
