...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="CL"></div>
      ...
      <div class="panel-heading">Packages
      <a class="btn btn-primary FR" href="/bdabdabda/packages/add_package/<?=$all_details['user_id']?>" >Add Package</a>
        ...
        <?php }?>
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td>
							<?php if($row->reviewed == 1): ?><label class="label label-success">Review Done</label><?php else: ?>
							<input type="button" value="Add Review" class="btn btn-primary add-review-btn" id="<?=$row->id?>" />
							<?php endif; ?>
						</td>
					</tr>
					<?php endforeach; ?>
