...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div class="col-md-8 col-md-offset-2">
      ...
      <div class="InputsWrapper" id="other_speciality">
        <?php
          ...
          {
            echo '<div><input type="text" class="form-control" name="speciality_other[]" value="'.ucfirst($name).'" /><a href="javascript:void(0);" class="removeclass btn btn-danger" id="other_speciality">Remove</a><br/></div>';
          }
        ?>
      </div>
      <div class="AddMoreFileId">
        ...
        <?php
         ...
         foreach($all_details['qualification_name'] as $qname): ?>
          <div>
            ...
            <?php endforeach; reset($qualifications);?>
            </select>
      ...
      <div class="InputsWrapper" id="degree_other">
        <?php
          ...
          {
            echo '<div><input type="text" class="form-control" name="degree_other[]" value="'.ucfirst($name).'" /><a href="javascript:void(0);" class="removeclass btn btn-danger" id="degree_other">Remove</a><br/></div>';
          }
        ?>
      </div>
      <div class="AddMoreFileId">
  ...
  if(id == 'speciality')
  {
  $(".InputsWrapper#speciality").last().append('<div><select name="speciality[]" class="form-control"><?php foreach($speciality as $spname): ?><option value="<?=$spname->id?>"><?=ucfirst($spname->name)?></option><?php endforeach; ?></select><a href="javascript:void(0);" class="removeclass btn btn-danger" id="speciality">Remove</a></div>');
  }
  else if(id == 'degree')
  {
  $(".InputsWrapper#degree").last().append('<div><select name="degree[]" class="form-control"><?php foreach($qualifications as $qlname): ?><option value="<?=$qlname->id?>"><?=ucfirst(str_replace("'","",$qlname->name))?></option><?php endforeach; ?></select>&nbsp;<a href="javascript:void(0);" class="removeclass btn btn-danger">Remove</a></div>');
  }
  else if(id == 'degree_other')
  {
  $(".InputsWrapper#degree_other").last().append('<div><input type="text" name="degree_other[]" class="form-control" value="" /><a href="javascript:void(0);" class="removeclass btn btn-danger" id="degree_other">Remove</a><br/></div>');
  }
  else if(id == 'other_speciality')
  {
  $(".InputsWrapper#other_speciality").last().append('<div><input type="text" class="form-control" name="speciality_other[]" value="" /><a href="javascript:void(0);" class="removeclass btn btn-danger" id="other_speciality">Remove</a><br/></div>');
  }
