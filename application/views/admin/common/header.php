<nav class="navbar-inverse" role="navigation">
   ...
   <div class="collapse navbar-collapse" id="navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <ul class="dropdown-menu">
	        <li><a href="/bdabdabda/boxmanager/health_utsav">Feature Helath Utsav</a></li>
          ...
          <li><a href="/bdabdabda/masters/raw_sms_log">Sms Log</a></li>
        </ul>
        </li>
        <?php } ?>
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="/bdabdabda/setting/custom_sms">Custom sms</a></li>
        </ul>
        </li>
        <?php } ?>
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="/bdabdabda/knowlarity/call_phone_record">Phone Record</a></li>
        </ul>
        </li>
        <?php } ?>
