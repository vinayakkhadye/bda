...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
 	  <title>In Process Appointments | BDA</title>
  ...
  <body>
          ...
          <?php if ($new_apponts) 
            {
              ...
              {?>
                ...
                <td>
                  <?php echo ($row->revisited_date)? date('d-m-Y h:i a', strtotime($row->revisited_date)):'add date';?>
                </td>
                <td>
    ...
    // Open close sub Part of appointment
