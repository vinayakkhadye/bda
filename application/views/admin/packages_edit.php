...
<form method="POST" name="seach_doctors" data-toggle="validator">
  ...
  <div class="form-group">
		...
		<option value="1" <?php if($user_package_details->current_status == '1') echo "selected='selected'"; ?> >In Use Package</option>
		<option value="0" <?php if($user_package_details->current_status == '0') echo "selected='selected'"; ?> >Sub Package</option>
		<option value="-1" <?php if($user_package_details->current_status == '-1') echo "selected='selected'"; ?> >Expire Package</option>
    </select> 
  </div>
	<div class="form-group">
