...
<div class="radio"><input type="radio" name="status" value="" /> Any</div>
<div class="radio"><input type="radio" name="status" value="1" <?=(isset($status) && $status == 1)?'checked':''?> /> Approved</div>
<div class="radio"><input type="radio" name="status" value="0" <?=(isset($status) && $status == 0)?'checked':''?> /> Pending</div>
<div class="radio"><input type="radio" name="status" value="-1" <?=(isset($status) && $status == -1)?'checked':''?> /> Disapproved</div>
<div class="radio"><input type="radio" name="status" value="-2" <?=(isset($status) && $status == -2)?'checked':''?> /> Deleted</div>
<div class="radio"><input type="radio" name="status" value="" /> Any</div>
</div>
<div class="form-group" > 
