...
<td>
  <?php if($row->status==1){ echo '<span class="label label-success">Approved</span>';}else if($row->status==0){ echo '<span class="label label-info">Pending</span>';}else if($row->status==-1){ echo '<span class="label label-error">Disapproved</span>';}?>
</td>
<td>
