...
<head>
<title>Knowlarty Call Records | BDA</title>
...
<div class="panel-heading">Call Record</div> 
...
<table class="table table-striped table-bordered table-hover">
  ...
  <td class="center"><a href='<?php echo ucfirst($row->recording_url); ?> '>
  <?php if($row->recording_url=="None"){echo "None";}else{echo "Download";}?></a></td>
  </tr>
  <?php }} ?>
  </tbody>
</table>
...
if (max_row_id) {
$.ajax({
  url:        '/bdabdabda/knowlarity/new_call_record',
  type:       'POST', 
  cache:      false,
  dataType:   'json',
