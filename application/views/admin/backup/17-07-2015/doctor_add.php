		...
		<div class="panel panel-default">
			...
			<form id="sl_step2" name="sl_step2" method="POST" enctype="multipart/form-data" action="" data-toggle="validator">
					<div class="col-md-8 col-md-offset-2"> 
							...
							<input name="summary" type="text"   class="form-control"  required />
							</div>
							...
							<div class="form-group ">
							<label class="control-label">Council ID. :  
							</label>
							...
							<div class="form-group ">
							<label class="control-label">Speciality :  
							</label> 
							...
							<div class="form-group ">
							<label class="control-label">Year of experience :  
							</label>
							...
							<input name="contact_number" value="" type="text"  class="form-control"  />
							</div>

							<div class="form-group ">
							<label class="control-label">Is Verified registered:  
							</label>
							...
							<div class="form-group ">
							<label class="control-label">Created On :  
							</label>
							<?php 
							$time = time(); 
							...
							<div class="form-group ">
							<label class="control-label">Is Sponsored :  
							</label>
							...
							<div class="form-group ">
							<label class="control-label">Is Paid :  
							</label>
