...
<form class="form-inline" method="GET" action="">
  <div class="form-group">
    <label class="control-label">States Name : </label>
...
<form name="edit_records" id="edit_records" method="post" class="" >
    ...
    <table class="table table-striped table-condensed table-bordered table-responsive">
							...
							<tr>
								...
								<td>
									<input type="text" class="country-field form-control" id="<?php echo $row->id; ?>" readonly value="<?php echo @$row->country_id; ?>" />
								</td>
								<td>
		...
		$(document).ready(function()
			{
				...
				$(".sort-field").add(".name-field").add(".country-field").on('dblclick', function()
					{
						$(this).attr('readonly', false);
					});
				$(".sort-field").add(".country-field").add(".name-field").on('blur', function()
					{
						$(this).attr('readonly', true);
					});
				$(".sort-field").add(".country-field").add(".name-field").keypress(function(e)
					{
						if(e.which == 13) 
					    {
					    	$(this).trigger('blur');
				...
				$(".sort-field").on('change', function()
					{
						...
						$.ajax(
						{
							url:'/bdabdabda/masters/update_sort/states',
							type:"POST",
							data:{
								'recordid':recordid,
								'sortvalue':sortvalue
				...
				$(".name-field").on('change', function()
					{
						...
						$.ajax(
						{
							url:'/bdabdabda/masters/update_name/states',
							type:"POST",
							data:{
								'recordid':recordid,
				...
				$(".country-field").on('change', function()
					{
						...
						$.ajax(
						{
							url:'/bdabdabda/masters/update_countryid',
							type:"POST",
							data:{
								'recordid':recordid,
								'countryid':countryid
