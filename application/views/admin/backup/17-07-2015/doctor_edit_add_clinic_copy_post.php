  ...
  <form id="sl_step2" name="sl_step2" method="POST" enctype="multipart/form-data" action="" data-toggle="validator">
    ...
    <table class="table table-striped table-condensed table-bordered table-responsive">
      <tr>
        ...
        <td colspan="3">Second Half</td>
        <td><a href="javascript:void(0)" id="copy_to_all_days">All</a></td>
      </tr>
      <tr>
...
<script src="http://maps.google.com/maps?file=api&v=3&key=AIzaSyCO8K3lZSCQgKMnmIyExMyglEI4s0FV4Uo"></script>
