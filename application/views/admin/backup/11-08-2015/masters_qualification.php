...
<html lang="en">
<head>
  <title>Qualification Master | BDA</title>
...
<form class="form-inline" method="POST" data-toggle="validator">
  ...
  <div class="form-group">
    ...
    <input name="new_sort_order" id="new_sort_order" type="number" class="form-control" value=""/>
  </div>
  <div class="form-group">
...
$(".sort-field").on('change', function()
	{
		...
		$.ajax(
		{
			url:'/bdabdabda/masters/update_sort/qualification',
			type:"POST",
			data:{
				'recordid':recordid,
				'sortvalue':sortvalue
