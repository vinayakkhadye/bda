...
<?php if($row->status == 1){echo 'Approved';}else if($row->status == 0){echo 'Pending';}else if($row->status==-1){echo 'Disapproved';}else if($row->status==-2){echo 'Deleted';}else if($row->status==3){echo 'Duplicate';}?>
</td>
<td>
