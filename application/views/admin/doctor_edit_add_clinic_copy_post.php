...
<div class="container-fluid">
  ...
  <div class="panel-body">
    ...
    <input name="health_utsav_place" value="<?php if(isset($_POST['health_utsav_place']))echo $_POST['health_utsav_place'];else{if(@$clinic_details->health_utsav_place)echo @$clinic_details->health_utsav_place;}?>" id="health_utsav_place" type="text" class="form-control" placeholder="some-place-slug" />
    </div>
    <div class="form-group">
