    ...
    <div class="doctor-pro-display-panel cf">
      <div class="two-third margin-bottom-0">
        <div class="profile-photo-panel">
              ...
              <img src="<?php echo $val['doctor_image']?>" alt="<?php echo $val['doctor_name']?>">
            </div>
        ...
        <div class="profile-description-panel">
            <a 
            href="<?=BASE_URL?>profile/<?php echo url_string(replace_special_chars($val['doctor_name']))?>/<?php echo $val['doctor_id'];?>.html">
      ...
      <ul class="profile-work-details">
          ...
          <?php if($val['consultation_fees']){ ?>
            ...
            <ul>
            	<?php foreach($val['disptimings'] as $time_key=>$time_val){ ?>
	              <li class="bold-text"><?=$time_val['value']?></li>
          ...
          <?php }else if($val['is_ver_reg']==1 || $val['is_number_verified']==1 ){?>
            <li class="cf">
