...
<html>
  ...
  <body>
    <div id="header">
      <h1 class="display-none"><?=$metadata['description'] ?></h1>
    	...
    	<div class="container cf">
      	<div class="doctor-pro-display-panel cf">
            ...
            <div class="profile-description-panel pro-page-profile-description-panel">
              <h2>Dr. <?php echo str_replace("Dr.","",$doctor['doctor_name']); ?></h2>
                ...
                <div id="tabs-1-doctor-profile">
                  ...
                  <div class="doctor-clinic-more-details cf">
                    <div class="one-third margin-bottom-0">
                      ...
                      <a href="javascript:;" id="clniic-view-map" latitude="<?=$clVal['clinic_latitude'] ?>" longitude="<?=$clVal['clinic_longitude'] ?>" class="clinic-location-map-bt">View Map</a>
                      <?php }?>
                    </div>
                    ...
                    <div class="one-third margin-bottom-0">
                      ...
                      <?php if($doctor['quick_appointment']==1){ ?>
                        <div id="quick-appointment" class="profile_appointment_via_time">
                          Book<span>Dr</span>Appointment
                        </div>	
                          <!--<a href="javascript:;" class="quick-appointment-bt profile_appointment_via_time" ><span>Book Dr Appointment</span></a>-->
                       <?php }else if($doctor['is_ver_reg']==1 || $clVal['is_number_verified']==1 ){?>
                        <!--<img src="/static/images/ic_phone_appointment.png" alt="Doctor Phone Appointment">-->
                        <div id="phone-appointment" class="profile_appointment_via_phone">
                            Appointment
                              <span>via Phone</span>
                          </div>	
                      <!--<a href="javascript:;" class="quick-appointment-bt profile_appointment_via_phone" ><span>Appointment Via Phone</span></a>-->
                      <?php }else{?>
                      
                      <div id="book-appointment" class="profile_appointment_via_time">
                        Book<span>Dr</span>Appointment
                      </div>	
    ...
    <div class="modalbpopup2" style="display: none;">
	    <img src="http://www.bookdrappointment.com/static/images/bdaloader.gif">
    </div>
    ...
    if($(".review_text_field_box").val().trim() == '')
    {
