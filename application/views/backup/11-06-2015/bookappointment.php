...
<div class="container cf" id="apt"><!--container cf Start-->
  ...
  <div class="appointment-doctor-pro-display-panel2 cf" id="appointment_container"><!--appointment-doctor-pro-display-panel2 Start-->
    ...
    <div class="appointment-doctor-social-Box2"><!--appointment-doctor-social-Box2 Start-->
      ...
      <form id="form1" name="form1" method="post" action="">
        ...
        <div class="appointment-doctor-FormBox1">
          ...
          <input type="text" name="mobile_number" id="mobile_number" value="<?=(isset($patient_name)?$mobile_number:'')?>" onKeyUp="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" />
        </div>
        <!--appointment-doctor-FormBox1 End-->
        <!--appointment-doctor-FormBox1 Start-->
        <div class="appointment-doctor-FormBox1">
    ...
    <div class="appointment-doctor-FormBox2 hide" id="miss_call_msg"><!--appointment-doctor-FormBox2 Start-->
      <div class="appointment-doctor-FormBox2Inner"><!--appointment-doctor-FormBox2Inner Start-->
      <div class="Left45">
      <img src="<?php echo IMAGE_URL; ?>appoint1.png" alt="Login">
      </div>
      <div class="Right45">
      <p>Please give a missed call on Toll free Number </p>
      <a href="tel:02249425883"><span>022 49 425 883</span></a>
      <p>to verify your mobile number and confirm your appointment</p>
      </div>
...
<img src="https://maps.googleapis.com/maps/api/staticmap?center=<?=$lat_lng?>&zoom=14&scale=false&size=600x300&maptype=roadmap&format=png&visual_refresh=true&markers=size:mid|color:red|label:1|<?=$lat_lng?>&markers=size:mid|color:red|label:1|<?=$lat_lng?>" alt="Google Map" style="width:100%;height:100%"></a>
</div>
<?php }?>
...
$("#miss_call_msg").show();
$("#appointment_done").hide();

//$("#mobile_number").attr("readonly",true);
myInterval = setInterval(function(){ verified_caller(appointment_id); }, 5000);
}
else
{
...
function verified_caller(appointment_id)
{
	var mobile_number = $("#mobile_number").val();
	if(mobile_number)
	{
...
$.ajax(
{
url: '<?=BASE_URL?>/bookappointment/saveappointment',
type: "POST",
data:obj,
