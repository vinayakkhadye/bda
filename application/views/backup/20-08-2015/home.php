...
<body>
  ...
  <div id="banner">
      ...
      <div class="cf thumb-slider">
      	<a href="<?=BASE_URL.$cityName?>/health-utsav" title="Pune Health Utsav Pimple Saudagar">
        <img src="<?=IMAGE_URL?>healthutsav.jpg" 
        alt="Pune Health Utsav Pimple Saudagar" style="width:100%">
        </a>
      </div>
      <?php } ?>
      <?php
