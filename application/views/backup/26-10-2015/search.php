  ...
  <h1 class="h1_sm_display"><?=$metadata['h1_text'] ?></h1>
    ...
    <div class="doctor-pro-display-panel cf">
      ...
      <ul class="profile-work-details">
          ...
          <li class="cf">
            <span style="font-weight: bold; color:#ff4d4d;"><?=$val['health_utsav_text']?></span>
          </li>
          <?php }?>
          ...
          <?php }else if($val['is_number_verified']==1 ){#$val['is_ver_reg']>0 || ?>
    ...
    <div class="breadcrum-container">
      ...
      <h5><a href="<?=BASE_URL.$query['city']?>"><span><?=ucfirst(reverse_url_string($cityName))?></span></a></h5> / 
