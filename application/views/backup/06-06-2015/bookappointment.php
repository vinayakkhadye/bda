...
<img src="http://maps.googleapis.com/maps/api/staticmap?center=<?=$lat_lng?>&zoom=14&scale=false&size=600x300&maptype=roadmap&format=png&visual_refresh=true&markers=size:mid|color:red|label:1|<?=$lat_lng?>&markers=size:mid|color:red|label:1|<?=$lat_lng?>" alt="Google Map" style="width:100%;height:100%"></a>
</div>
<?php }?>
