...
<body>
	<div id="header">
  	<h1 class="display-none">Book Doctor Appointment Online Instantly</h1>
  ...
  <div id="banner">
      ...
      <ul class="appointment-steps">
        ...
        <div id="tabs-1">
          <input class="search-speaciality" type="text" id="speciality" value="" url-data="" placeholder="Dentist, Pediatrician, Gynaecologist etc." />
          <input class="search-location" type="text" id="location" url-data="" placeholder="in Location" />
          <input type="submit">
          <img src="<?=IMAGE_URL?>free-text.jpg" alt="Ohh yes It's Free"> 
        </div>
        <div id="tabs-2">
	        <input class="search-name" type="text" id="doctor_name" placeholder="Doctor Name" />
          <input type="submit">
          <img src="<?=IMAGE_URL?>free-text.jpg" alt="Ohh yes It's Free"> 
        </div>
        <div id="tabs-3">
	        <input class="search-name" type="text" id="clinic_name" placeholder="Clinic Name"/>
          <input type="submit">
          <img src="<?=IMAGE_URL?>free-text.jpg" alt="Ohh yes It's Free"> 
        </div>
        </div>
      ...
      <?php
        ...
        <?php foreach($top_speciality as $top_spKey=>$top_spVal)
				{ ?>
        <div class="item">
          <span><img src="<?php echo BASE_URL.$top_spVal['display_image']?>"/></span>
      ...
      <div class="container">
          ...
          <div class="mobile-view-show">
            ...
            <div class="play-store-image cf">
              <a href="https://play.google.com/store/apps/details?id=com.bookdrappointment.doctorapp&hl=en">
	              <img src="<?=IMAGE_URL?>play-store-image-black.jpg" class="float-right" alt="Google Play Store BDA App Icon">
              </a>
						</div>
          </div>
