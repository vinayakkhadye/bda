...
<div class="container cf">
        <div class="breadcrum-profile-container" id="breadcrum">
          ...
          <?php if(isset($clinicData[0]['location']) && is_array($clinicData[0]['location'])){?>
                  ...
                  <div class="doctor-clinic-more-details cf">
                    ...
                    <div class="one-third margin-bottom-0">
                      ...
                      <?php if($doctor['quick_appointment']==1){ ?>
                       ...
                       <?php }else if($clVal['is_number_verified']==1 ){#$doctor['is_ver_reg']>0 || ?>
    ...
    <div class="modalbpopup2" style="display: none;">
	    <img src="<?=IMAGE_URL?>bdaloader.gif">
    </div>
