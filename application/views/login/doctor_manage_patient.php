...
<body onload="return  getcustomer(this)"><!--dr_hospital_list(this),-->
...
<div class="row">
  ...
  <a href="javascript:;" id="patient_documents" class="disabled list-group-item" >Documents</a>
  </div>      
  </div>
  ...
  <div class="col-sm-12 col-xs-12 col-md-10 col-lg-10 H550" id="patient-list">
    <div class="panel panel-default">
      ...
      <div class="form-group">
      <input type="text" class="form-control" value="" name="patient_name" placeholder="Patient name" id="search_box">
      </div>
      <div class="form-group">
      <button onclick="return getcustomer(this)" name="search" value="Search" class="btn btn-default" id="search_btn">Search</button>
      </div>
      </div>
      </div>
  ...
  <div class="col-sm-12 col-xs-12 col-md-10 col-lg-10" id="patient-documents-details" style="display:none">
    <div class="panel panel-default">
      <div class="panel-heading">Patient Documents <span style="margin-left:20px;" class="FR glyphicon glyphicon-filter" id="filter_document"></span> <span class="FR glyphicon glyphicon-plus " id="add_document"></span></div>
      <div class="panel-body">
 				<form name="create_document" id="create_document" class="form-horizontal" role="form" data-toggle="validator" enctype="multipart/form-data">
          <div class="form-group">
            <label class="control-label col-sm-2 col-lg-2 col-md-2 col-xs-0" for="document_title">Title</label>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
              <input type="text" class="form-control" name="title" id="document_title" placeholder="Enter Title" required>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2 col-lg-2 col-md-2 col-xs-0" for="report_type">Report Type</label>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <input type="text" class="autocomplete-report-type form-control" name="report_type" id="report_type" placeholder="Enter Report Type" required>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2 col-lg-2 col-md-2 col-xs-0" for="document_file">File</label>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            <button id="myDocBtn" class="btn btn-info btn-md" type="button"><span class="glyphicon glyphicon-upload"></span>&nbsp;Select a File</button>
            <span id="document_name"></span>
            <input type="file" id="document_file" name="document_file" class="hide" required/> 
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2 col-lg-2 col-md-2 col-xs-0" for="report_date">Report Date</label>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
              <input type="text" class="form-control" name="report_date" id="report_date" placeholder="Enter Date" required>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2 col-lg-2 col-md-2 col-xs-0" for="report_date">Report Notes</label>
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
              <textarea class="form-control" name="report_notes" id="report_notes"  required placeholder="Write a Note.."></textarea>
            </div>
          </div>
          
          <div class="form-group">
            <div class="col-sm-offset-2 col-lg-offset-2 col-md-offset-2 col-xs-offset-0 col-lg-8 col-md-8 col-sm-8 col-xs-12">
              <button type="submit" class="btn btn-default">Add</button>
            </div>
          </div>
          <hr />
        </form>
        <form name="search_document" id="search_document" class="form-horizontal" role="form">
          <div class="form-group">
            <label class="control-label col-sm-4 col-lg-2 col-md-2 col-xs-4" for="search_report_title">Title</label>
            <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
            <input type="text" class="form-control" id="search_report_title" name="search_report_title" >
            </div>
          
            <label class="control-label col-sm-4 col-lg-2 col-md-2 col-xs-4" for="search_report_type">Report Type</label>
            <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
            <input type="text" class="form-control autocomplete-report-type" id="search_report_type" name="search_report_type">
          </div>
          </div>  
          <div class="form-group">
            <label class="control-label col-sm-4 col-lg-2 col-md-2 col-xs-4" for="search_from_report_date">Report Date</label>
            <div class="col-lg-4 col-md-4 col-sm-3 col-xs-3">
            <input type="text" class="form-control" id="search_from_report_date" name="search_from_report_date" placeholder="From">
            </div>
            <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-1 col-xs-offset-1 col-lg-4 col-md-4 col-sm-3 col-xs-3">
            <input type="text" class="form-control" id="search_to_report_date" name="search_to_report_date" placeholder="To">
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-4 col-lg-2 col-md-2 col-xs-4" for="search_notes">Notes</label>
            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-8">
            <input type="text" class="form-control" id="search_notes" name="search_notes">
            </div>
          </div>
          <div class="form-group">
          <div class="col-lg-offset-2 col-lg-10 col-sm-8 col-md-10 col-xs-10 col-sm-offset-4 col-md-offset-2 col-xs-offset-4">    
          <button type="submit" class="btn btn-default">Search</button>
          </div>
          </div>
        </form>
      	<div class="PB15 ajax-content" id="patient_documents_content"></div>
      </div>
    </div>
  </div>
...
$(function(){
var	report_type	=	["Lab Report","X Ray Report","Prescription"];
$(".autocomplete-city").autocomplete({
	...
	$( ".autocomplete-report-type" ).autocomplete({
		source: report_type,
		minLength: 0
		...
		$(window).load(function() {
				...
				$('#btnCrop').on('click', function(){
						...
						$('#profileimgbox').html('<img src="'+img+'" style="width:126px;">');
...
$(function(){
	...
	$('#document_file').on('change', function(){
		$("#document_name").html(this.files[0].name);
	});
	...
	$("#report_date, #edit_report_date, #search_from_report_date, #search_to_report_date").datetimepicker({
		timepicker:false,
		format:'d-m-Y'
	});
	$("#add_document").click(function(){
		$( "#create_document" ).toggle('slow');
	});
	$("#filter_document").click(function(){
...
function getcustomer(page_id)
{
	...
	//for search box
	//if(obj['page_id']  == null){
	obj['patient_name'] =	$("#search_box").val();
	obj['clinic_id']  	=	$("#clinic_id").val(); 
	//}
	$.ajax({
	url:    '/doctor/patient_manage_data',
	type:   'POST',
	cache:  false,
	dataType: 'json',
	data:      obj,
	...
	success: function(resp){ 
		...
		{     
			...
			tmp	=		'<div class="col-xs-12 col-sm-6 col-lg-3 col-md-6 H150">';
      ...
      tmp	+=	'</div>';
		...
		var lPage = (resp.pagination['lPage'])?resp.pagination['lPage']:'';
...
function active_navigation_class(id_name)
{
	...
	//$( ".list-group a" ).each(function(index){
		if(id_name=="add_new_patient")
		{
			...
			$("#patient_documents").addClass('disabled');
			...
			$("#patient_documents").removeClass('active');
		}
		...
		else if(id_name=="patient_general_info")
		{
			...
			$("#patient_documents").removeClass('disabled');
		}
		...
		else if(id_name=="patient_documents")
		{
			$("#all_customer").removeClass('active');
			$("#add_new_patient").removeClass('active');
			$("#patient_general_info").removeClass('active');
...
function add_patient()
{
	...
	$.ajax({type: 'POST',
			url: "/doctor/patient_add/",
			data: form_data,
			beforeSend:function(){loading();},
			success: function(data){getcustomer(1);},
			complete:function(data){removeLoading();}
		});
		return false;
}
...
function patient_general_profile(patient_id)
{
	$.ajax({
		...
		success: function(resp){
			...
			$("#patient_documents").attr('onclick','return patient_documents_list(this,'+resp.id+')');
			...
			$("#profileimgbox img").css("width","126px");
			...
			$("#patient-family-details").hide();
			$("#patient-disease-sugery").hide();
			$("#patient-documents-details").hide();
			$("#patient-details").show();
		},
		complete: function(){removeLoading();}
	});	
...
{
	$.ajax({
		url: '/doctor/patient_disease_surgeries',
		type: 'POST',
		cache: false,
		data:{'id':patient_id},
		beforeSend: function() {loading();},
...
{
	$.ajax({
		url: '/doctor/get_patient_self_family_history',
		type: 'POST',
		cache: false,
		data:{'id':patient_id},
		beforeSend: function() {loading();},
...
function patient_documents_list(obj,patient_id,page)
{
	var limit									=	2;
	var page									=	(page)?page:1;
	var data									=	{'user_type':2,'patient_id':patient_id,'doctor_id':<?=$doctor_data->id ?>};
	data['title']							=	$("#search_report_title").val();
	data['report_type']				=	$("#search_report_type").val();	
	data['from_report_date']	=	$("#search_from_report_date").val();	
	data['to_report_date']		=	$("#search_to_report_date").val();	
	data['notes']							=	$("#search_notes").val();
	data['limit']							=	limit;
	data['page']							=	page;
	...
	$.ajax({
		...
		success: function(resp){
			...
			$("#patient-disease-sugery").hide();
			$("#patient-family-details").hide();
			$("#patient-documents-details").show();
			active_navigation_class('patient_documents');
			$("#create_document").attr('onsubmit','return patient_documents_create(this,'+patient_id+');');
			$("#search_document").attr('onsubmit','return patient_documents_list(this,'+patient_id+');');
			var response	=	resp.response;
			if(response.status=1)
			{
				
				var html	=	'';
				html	+=	'<div class="row file_header" style="padding:5px 0; background: #ebebeb; font-weight:bold; margin-bottom:10px;">';
				html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">File</div>';
				html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">Title</div>';
				html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">Report Type</div>';
				html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">Report Date</div>';
				html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">Notes</div>';
				html	+=	'</div>';
				for (i in response.file_data)
				{
					console.log(response.file_data[i]);
					html	+=	'<div class="row" style="padding:10px; margin:10px 0;" id="'+response.file_data[i].file_id+'" >';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12"><img class="W100" src="'+BASE_URL+'api/user_files/display?file_id='+response.file_data[i].file_id+'&thumbnail=1" /></div>';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" id="title">'+response.file_data[i].title+'</div>';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12"  id="report_type">'+response.file_data[i].report_type+'</div>';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12"  id="report_date">'+response.file_data[i].report_date+'</div>';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" id="notes">'+((response.file_data[i].notes)?response.file_data[i].notes:'')+'</div>';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12"><a href="javascript:;" onclick="patient_documents_delete(this,'+patient_id+','+response.file_data[i].file_id+')"><span class="glyphicon glyphicon-trash"></span> Remove</a> <br/><a href="javascript:;" onclick="patient_documents_edit_modal(this,'+patient_id+')"><span class="glyphicon glyphicon-edit"></span> Edit</a></br> <a href="'+BASE_URL+'api/user_files/download?file_id='+response.file_data[i].file_id+'" ><span class="glyphicon glyphicon-download-alt"></span> Download</a></div>';
					html	+=	'</div>';
				}
				...
				if(response.pagination)
				{
					...
					for(i in response.pagination.page)
					{ 
						html	+=	'<li '+((page	==	i)?'class="active"':'')+'><a href="javascript:;" '+response.pagination.page[i].click+'>'+i+'</a></li>';
					}
					html	+=	'</ul>';
				}
				$("#patient_documents_content").html(html);
				$("#create_document").css('display','none');
				$("#search_document").css('display','none');
			}
		},
		complete: function(){removeLoading();}
	});	
...
function patient_documents_create(obj,patient_id)
{
	var formData	= new FormData();
	var doc				= document.getElementById("document_file");
	...
	formData.append("filedata", doc.files[0]);	
	formData.append("file_name", doc.files[0].name);	
	formData.append("notes", $("#report_notes").val());	
	formData.append("doctor_id", <?=$doctor_data->id ?>);	
	//formData.append("file_path", false);
	
	$.ajax({
		url: '/api/user_files/create_1',
		type: 'POST',
		cache: false,
		contentType: false,
    processData: false,		
		...
		success: function(resp){
			...
			{
					var html	=	''
					html	+=	'<div class="row" style="padding:10px; margin:10px 0;" id="'+response.file_data.file_id+'" >';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12"><img class="W100" src="'+BASE_URL+'api/user_files/display?file_id='+response.file_data.file_id+'&thumbnail=1" /></div>';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" id="title">'+response.file_data.title+'</div>';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12"  id="report_type">'+response.file_data.report_type+'</div>';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12"  id="report_date">'+response.file_data.report_date+'</div>';
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" id="notes">'+((response.file_data.notes)?response.file_data.notes:'')+'</div>';
					
					html	+=	'<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12"><a href="javascript:;" onclick="patient_documents_delete(this,'+patient_id+','+response.file_data.file_id+')"><span class="glyphicon glyphicon-trash"></span> Remove</a> <br/><a href="javascript:;" onclick="patient_documents_edit_modal(this,'+patient_id+')"><span class="glyphicon glyphicon-edit"></span> Edit</a></br> <a href="'+BASE_URL+'api/user_files/download?file_id='+response.file_data.file_id+'" ><span class="glyphicon glyphicon-download-alt"></span> Download</a></div>';
					html	+=	'</div>';
					//$("#patient_documents_content .file_header").next(html);
					$(html).insertAfter("#patient_documents_content .file_header");
					$("#document_title").val('');
					$("#report_type").val('');
					$("#report_date").val('');
					$("#report_notes").val('');
...
function patient_documents_delete(obj,patient_id,file_id)
{
	var	data	=	{'user_type':2,'patient_id':patient_id,'file_id':file_id,'doctor_id':<?=$doctor_data->id ?>};
	$.ajax({
		url: '/api/user_files/delete',
		type: 'POST',
		cache: false,
		data:data,
		beforeSend: function() {loading();},
...
function patient_documents_download(obj,patient_id)
{
	var row	=	$(obj).parent().parent();
	var data	=	{'user_type':2,'file_id':row.attr("id"),'doctor_id':<?=$doctor_data->id ?>};
	$.ajax({
		url: '/api/user_files/download',
		type: 'GET',
		cache: false,
		data:data,
		beforeSend: function() {loading();},
...
function patient_documents_edit(obj,patient_id)
{
	var formData	= new FormData();
	formData.append("title", $("#edit_document_title").val());	
	formData.append("user_type", 2);	
	formData.append("patient_id", patient_id);	
	formData.append("file_id", $("#edit_file_id").val());	
	formData.append("report_type", $("#edit_report_type").val());	
	formData.append("report_date", $("#edit_report_date").val());	
	formData.append("notes", $("#edit_report_notes").val());	
	formData.append("doctor_id", <?=$doctor_data->id ?>);	
		
	$.ajax({
		url: '/api/user_files/edit_1',
		type: 'POST',
		cache: false,
		contentType: false,
    processData: false,		
		...
		success: function(resp){
			if(resp.response.status=1)
			{
				...
				var row			=	$("#"+file_id);
				console.log(row);
				row.find("#title").html($("#edit_document_title").val());
				row.find("#report_type").html($("#edit_report_type").val());
				row.find("#report_date").html($("#edit_report_date").val());
				row.find("#notes").html($("#edit_report_notes").val());
...
function patient_documents_edit_modal(obj,patient_id)
{
	var row	=	$(obj).parent().parent();
	
	$("#edit_document_title").val($(row).find("#title").html());
	$("#edit_report_type").val($(row).find("#report_type").html());
	$("#edit_report_date").val($(row).find("#report_date").html());
	$("#edit_report_notes").val($(row).find("#notes").html());
	$("#edit_file_id").val(row.attr("id"));
	
	$("#edit-patient-modal").modal({backdrop: true});
	$("#edit_document").attr('onsubmit','return patient_documents_edit(this,'+patient_id+');');
		...
		$.ajax({
			...
			success: function(resp){
				...
				if(resp.success)
				{
					insert_id=resp.success;
					var html_family	=	'';
                                        //html_family	+=	'<div class="form-inline">';
					html_family	+=	'<div class="form-inline form-group">';
					html_family	+=	'<label class="control-label">Surgery</label>';
					html_family	+=	'<input readonly type="text" class="form-control" value="'+surgery_name+'"/>';
					//html_family	+=	'</div>';
					//html_family	+=	'<div class="form-group">';
					//html_family	+=	'<label class="control-label">Reason For Surgery : </label>';
					html_family	+=	'<input readonly type="text" class="form-control" value="'+surgery_reason+'" >';
					//html_family	+=	'</div>';
					//html_family	+=	'<div class="form-group">';
					//html_family	+=	'<label class="control-label">Reason For Surgery : </label>';
					html_family	+=	'<input readonly type="text" class="form-control" value="'+surgery_date+'" >';
					html_family	+=	'<button class="btn btn-danger glyphicon glyphicon-minus" id="past_surgery_delete" db-id="'+insert_id+'" onclick="return removeelement(this);"></button>';
					html_family	+=	'</div>';
...
<!-- PAGE SPECIFIC JS-->
<div class="modal fade" id="edit-patient-modal" role="dialog">
  <div class="modal-dialog">
  <!-- Modal content-->
  <div class="modal-content">
  <div class="modal-header">
  ...
  <div class="modal-body">
  <form name="edit_document" id="edit_document" class="form-horizontal" role="form" data-toggle="validator" enctype="multipart/form-data">
    <div class="form-group">
      <label class="control-label col-sm-2 col-lg-2 col-md-2 col-xs-0" for="edit_document_title">Title:</label>
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <input type="text" class="form-control" name="title" id="edit_document_title" placeholder="Enter Title" required>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2 col-lg-2 col-md-2 col-xs-0" for="report_type">Report Type:</label>
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
      <input type="text" class="autocomplete-report-type form-control" name="report_type" id="edit_report_type" placeholder="Enter Report Type" 
      required>
      </div>
    </div>
    
    <div class="form-group">
      <label class="control-label col-sm-2 col-lg-2 col-md-2 col-xs-0" for="edit_report_date">Report Date:</label>
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <input type="text" class="form-control" name="report_date" id="edit_report_date" placeholder="Enter Date" required>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2 col-lg-2 col-md-2 col-xs-0" for="report_date">Report Notes:</label>
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <textarea class="form-control" name="report_notes" id="edit_report_notes"  placeholder="Write a Note.."></textarea>
      </div>
    </div>
