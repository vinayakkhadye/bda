...
}else if(str == "past_disease_table")
{
	...
	$("#meterperct").css("width","99%");
	$(".general_info_step").attr("id","circle1");
	$(".famili_history_step").attr("id","circle1");
	$(".past_disease_step").attr("id","circle1");
...
*/
	...
	function past_disease_more(obj)
	{
		var curTR = $(obj).closest('tr');
	...
	function past_surgery_more(obj)
	{
		var curTR = $(obj).closest('tr');
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr id="general_info_table" >
										<td bgcolor="">
											<table width="100%" border="0" cellspacing="0" cellpadding="0" >
												...
												<tr>
												<td align="center" class="from_text5">Date</td>
												...
												<td align="center"><?=date("Y-m-d",strtotime($bval->date)) ?></td>
												...
												<td>&nbsp;</td>
												<td><input name="weight" type="text" class="date" id="weight" value="" style="width:73px" /> Kgs. </td>
												<td>&nbsp;</td>
												</tr>
												<tr>
												<td align="right">&nbsp;</td>
												...
												<tr>
													...
													class="from_text3">Current Medication :</td>
												</tr>
												<tr>
													<td align="right">&nbsp;</td>
													<td>&nbsp;</td>
												...
												#exit;
												?>
												<tr id="ongoing_medications_more" class="from_text3">
													...
													<span id="ongoing_medications_remove" style="display:none" class="from_text4-org_1" onclick="remove_tr(this,'ongoing_medications','<?=$mVal->id?>');" 
													class="from_text4-org_1">&nbsp;Remove</span>
													<?php }else{?>
													<span id="ongoing_medications_remove" class="from_text4-org_1" 
													onclick="remove_tr(this,'ongoing_medications','<?=$mVal->id?>');">&nbsp;Remove</span>
													<?php }?>
													</td>
													<td>&nbsp;</td>
												</tr>
												...
												<tr id="ongoing_medications_more" class="from_text3">
													...
													class="from_text4-org_1 remove_tr">&nbsp;Remove</span>
													</td>
													<td>&nbsp;</td>
												</tr>
												<?php }?>
												...
												<tr id="allergic_more" class="from_text3">
												...
												<tr>
													...
													<div style="padding-right:45px;float:right;margin-right:10px;" class="continue_bnt save_details" 
													id="submit_form" onclick="show_hide_steps('save_details')">submit</div>
													</td>
												</tr>
									...
									<tr id="past_disease_table" style="display:none">
										<td bgcolor="#FFFFFF">
											<table width="100%" border="0" cellspacing="0" cellpadding="0" >
												<tr>
													<td height="31" colspan="4" align="left" valign="middle" bgcolor="#F6F6F6" 
											  ...
											  <tr id="past_disease_more">
												...
												<p>
												<input name="disease_duration[<?=$dKey?>]" type="text" class="date" value="<?=$dVal->disease_duration ?>" style="width:60px;"> Months
												</p>
												<p>
												...
												<img id="past_disease_more" src="<?=IMAGE_URL?>addmore.jpg" width="85" height="31" onclick="past_disease_more(this);" />
											  ...
											  <?php } ?>
												...
												<img id="past_surgery_more" src="<?=IMAGE_URL?>addmore.jpg" width="85" height="31" onclick="past_surgery_more(this);" />
												...
												<td colspan="5" height="53" align="right" bgcolor="#f5f5f5">
												<div style="padding-right:45px;float:right;margin-right:10px;" class="continue_bnt save_details" id="submit_form" 
												onclick="show_hide_steps('reports_table')">Continue</div>
			...
			<table>
				...
				<td align="right" valign="top">Disease Name  :<br /><br /><br /><br /><br />Duration  :</td>
				<td>&nbsp;</td>
				<td>
				...
				<p>
				<input name="disease_duration[<?=$past_disease_count?>]" dataid="<?=$past_disease_count?>" type="text" class="date" id="disease_duration_copy" value="<?=@$patientdetails->ciggi_per_day ?>" style="width:60px;"> Months
				</p>
				<p>
