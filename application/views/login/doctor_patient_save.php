...
<head>
	...
	<title>Book Dr Appointment</title>
		...
		<link rel="stylesheet" href="<?=CSS_URL?>login/font-awesome.min.css">
		<!--[if IE 7]>
		<link rel="stylesheet" href="assets/css/font-awesome-ie7.min.css">
		<![endif]-->
		<!-- <link rel="stylesheet" href="<?=CSS_URL?>admin/adminstyle.css"> -->
		<link href="<?=CSS_URL?>login/bootplus.css" rel="stylesheet">
		<link href="<?=CSS_URL?>login/bootplus-responsive.css" rel="stylesheet">

		<link href="<?=CSS_URL?>login/docs.css" rel="stylesheet">
		<link href="<?=CSS_URL?>login/prettify.css" rel="stylesheet">
 ...
 <body data-spy="scroll" data-target=".bs-docs-sidebar" >
        ...
        <?php $this->load->view('doctor_header'); ?>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="pricetable">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<?=(@$patientdetails->other_location)?"display:inline":"display:none"?>" >
				Select from list
										...
										<div style="padding-right:45px;float:right;" class="btn btn-success" 
										onclick="show_hide_steps('family_history_table')">continue <i class="icon-star"> </i></div>
 ...
 <!-- Footer
    ...
    <footer class="footer">
      <div class="container">
        <p>© 2014 BookdrAppointment.com, All rights reserved </p>
      </div>
    </footer>
...
<!-- Le javascript
    ...
    <script src="<?=JS_URL?>login/jquery.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-transition.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-alert.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-modal.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-dropdown.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-scrollspy.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-tab.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-tooltip.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-popover.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-button.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-collapse.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-carousel.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-typeahead.js"></script>
    <script src="<?=JS_URL?>login/bootstrap-affix.js"></script>

    <script src="<?=JS_URL?>login/holder.js"></script>
    <script src="<?=JS_URL?>login/prettify.js"></script>
